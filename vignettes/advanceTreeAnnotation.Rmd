...
For associating phylogenetic tree with different type of plot produced by user's data, `ggtree` provides `alnplot` function which accepts an input data frame and a geom function to draw the input data then align the plot with the tree. 
