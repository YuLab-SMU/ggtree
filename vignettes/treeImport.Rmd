...
We can also plot the _`dN`_ or _`dS`_ tree and others. More examples (include evidences inferred by BEAST) can be found in the [Tree Annotation](treeAnnotation.html) vignette.  
